	...
	<div class="entry-content">
		...
		<?php if ( has_category() ) : ?>
			<div class="entry-meta">
				<img class="icon" src="<?php echo get_template_directory_uri(); ?>/img/tbw-grfx-meta-ico-cal.png">
				&nbsp;<time datetime="<?php echo the_time('Y-m-j'); ?>"><?php echo the_time(get_option('date_format')); ?></time>
				&nbsp;<img class="icon" src="<?php echo get_template_directory_uri(); ?>/img/tbw-grfx-meta-ico-fold.png">
				&nbsp;<a href="#" rel="category"><?php the_category(', '); ?></a>
				&nbsp;<img class="icon" src="<?php echo get_template_directory_uri(); ?>/img/tbw-grfx-meta-ico-auth.png">
				&nbsp;<?php the_author_link(); ?>
			</div>
		<?php endif; ?>
